        ...
        <>
            ...
            <div className={`absolute left-0 top-0 md:relative z-40 w-full md:w-64 space-y-6 md:h-[calc(100vh-3rem)] h-screen border-r border-zinc-700/40 transform transition-transform ease-in-out dura overflow-hidden ${isOpen ? 'translate-x-0 p-6 bg-zinc-800' : '-translate-x-full md:translate-x-0 md:pr-6 pr-0'}`}>
                ...
                <div className="w-full space-y-2">
                    ...
                    <Link to="https://www.linkedin.com/in/abiola-abdulrahman-788608117" className='w-fit italic flex items-center gap-x-2 text-base text-zinc-300 hover:text-blue-500 px-3 py-2 ease-in-out duration-300'>
                        <FaLinkedin size={18} />
                        <span>@linkedin</span>
                    </Link>
                    <Link to="https://github.com/abiolamukaram?tab=repositories" className='w-fit italic flex items-center gap-x-2 text-base text-zinc-300 hover:text-neutral-500 px-3 py-2 ease-in-out duration-300'>
                        <FaGithub size={18} />
                        <span>@github</span>
                    </Link>

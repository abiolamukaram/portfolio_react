  ...
  return (
    <RootLayout className={"space-y-24"}>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex items-center gap-x-4">
            ...
            <div className="space-y-1">
              <p className="text-xs font-medium text-zinc-300">Email Address</p>
          ...
          <div className="flex items-center gap-x-4">
            ...
            <div className="space-y-1">
              <p className="text-xs font-medium text-zinc-300">Phone Number</p>
              <h2 className="text-base text-zinc-50 font-medium">
                +2348070599475
              </h2>
            </div>
      ...
      <div className="w-full space-y-8">
        <div className="space-y-2">
          <h1 className="text-2xl text-zinc-50 font-bold">Get in touch</h1>
          <p className="text-sm font-medium">Feel free to ask about me.</p>
        </div>
        ...
        <div className="w-full grid md:grid-cols-2 grid-cols-1 gap-8 bg-zinc-700/20 rounded-lg md:p-8 p-6 border border-zinc-700/80">
          <div className="w-full space-y-2 md:col-span-1 col-span-2">
            <label
              htmlFor="name"
              className="text-sm text-zinc-300 font-medium flex"
            >
              Full Name
            </label>
            <input
              ...
              id="name"
              className="w-full rounded-lg p-3 border border-zinc-600 bg-zinc-700/10 text-zinc-50 outline-none focus:border-amber-400 ease-in-out duration-300"
            />
          </div>
          ...
          <div className="w-full space-y-2 col-span-2">
            ...
            <textarea
              placeholder="e.g. I want to create a website for my company"
              id="message"
              className="w-full rounded-lg p-3 h-28 border border-zinc-600 bg-zinc-700/10 text-zinc-50 outline-none focus:border-amber-400 ease-in-out duration-300"
            ></textarea>
          </div>
